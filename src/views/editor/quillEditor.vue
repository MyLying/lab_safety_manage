  ...
  <div class="app-container">
    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" label-position="top" label-width="100%">
      ...
      <el-card>
        ...
        <el-form-item label="通知公告正文" prop="noticeContent">
          <quill-editor v-model="postForm.noticeContent" />
        </el-form-item>

        <el-form-item label="通知公告时间" prop="noticeDate">
...
import { insert } from '@/api/notice/notice'
import { selectId } from '@/api/notice/notice'
