  ...
  <div class="app-container">
    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" label-position="top" label-width="100%">
      ...
      <el-card>
        ...
        <el-form-item label="规章制度标题" prop="noticeTitle">
          <el-input v-model="postForm.noticeTitle" />
        </el-form-item>

        <el-form-item label="规章制度正文" prop="noticeContent">
          <quill-editor v-model="postForm.noticeContent" />
        </el-form-item>

        <el-form-item label="规章制度时间" prop="noticeDate">
...
import { insert } from '@/api/rule/rule'
import { selectId } from '@/api/rule/rule'
