  ...
  <div class="app-container">
    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" label-position="top" label-width="100%">
      ...
      <el-card>
        ...
        <el-form-item label="安全知识标题" prop="noticeTitle">
          <el-input v-model="postForm.noticeTitle" />
        </el-form-item>

        <el-form-item label="安全知识正文" prop="noticeContent">
          <quill-editor v-model="postForm.noticeContent" />
        </el-form-item>

        <el-form-item label="安全知识时间" prop="noticeDate">
...
import { insert } from '@/api/safe/safe'
import { selectId } from '@/api/safe/safe'
