<template>
  <div>
    ...
    <div style="margin-top: 30px;margin-left: 1000px">
      <router-link to="/File/EditorSafes"><el-button type="success" round style="margin-right: 13px">添加</el-button></router-link>
...
<script>
import { passSafeDetailId, select } from '@/api/safe/safe'
import { passIds } from '@/api/safe/safe'
import { deleteId } from '@/api/safe/safe'
