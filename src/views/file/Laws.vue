<template>
  <div>
    ...
    <div style="margin-top: 30px;float: right">
      <router-link to="/File/EditorLaws"><el-button type="success" round style="margin-right: 13px">添加</el-button></router-link>
...
<script>
import { passLawDetailId, select } from '@/api/law/law'
import { passIds } from '@/api/law/law'
import { deleteId } from '@/api/law/law'
