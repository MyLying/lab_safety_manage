<template>
  <div>
    ...
    <div style="margin-top: 30px;margin-left: 1000px">
      <router-link to="/File/EditorRules"><el-button type="success" round style="margin-right: 13px">添加</el-button></router-link>
...
<script>
import { passRuleDetailId, select } from '@/api/rule/rule'
import { passIds } from '@/api/rule/rule'
import { deleteId } from '@/api/rule/rule'
