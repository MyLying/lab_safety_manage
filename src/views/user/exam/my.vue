      ...
      <template slot="data-columns">
        ...
        >
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.passed" @click="dwPdf(scope.row.realName,scope.row.title)">下载证书</el-button>
          </template>
...
export default {
  ...
  methods: {
    ...
    dwPdf(realName, title) {
      this.$router.push({ name: 'PdfDownload', params: { realName: realName, title: title }})
    }
  }
}
</script>
